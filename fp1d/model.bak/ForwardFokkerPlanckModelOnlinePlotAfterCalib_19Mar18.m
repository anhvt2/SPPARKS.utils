...
statisticalDistance = 	(L2norm(pSimCheck(1,:), pHistorySpparks(11,:), x) + ... 
						...
						(KLdistance(pSimCheck(1,:), pHistorySpparks(11,:), x) + ... 
						KLdistance(pSimCheck(2,:), pHistorySpparks(20,:), x) + ... 
						KLdistance(pSimCheck(3,:), pHistorySpparks(29,:), x) + ... 
						KLdistance(pSimCheck(4,:), pHistorySpparks(38,:), x))  ;
