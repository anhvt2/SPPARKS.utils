...
% inputFokkerPlanck = [5.00000000e-03, -7.98911869e-04,  1.50000000e-06,  3.50000000e-08];
xLB = [2.0e-03 -1.5e-03 1.11e-06 2.1e-08];
xUB = [8.0e-03 -0.5e-03 2.50e-06 5.0e-08];
...
numSeqPoint = 501;							% (numSeqPoint + 1) is the start of next iteration
