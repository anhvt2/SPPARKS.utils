...
% 4-param
% xLB = [2.0e-3 -1.5e-3 1.11e-06 2.1e-08];
% xUB = [8.0e-3 -0.5e-3 2.50e-06 5.0e-08];

% 6-param
xLB = [0.0e-3, 2.0e-3, -1.5e-3, 0.0e-6, 0.00e-06, 2.1e-08];
xUB = [1.0e-3, 8.0e-3, -0.5e-3, 1.0e-6, 2.50e-06, 5.0e-08];
...
numSeqPoint = 277;							% (numSeqPoint + 1) is the start of next iteration
